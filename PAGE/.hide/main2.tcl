...
#  Jul 10, 2025 06:11:48 PM JST  platform: Windows NT
set vTcl(timestamp) ""
...
proc vTclWindow.top1 {base} {
    ...
    ttk::combobox "$site_3_0.tCo54" \
        -font "-family {Yu Gothic UI} -size 9" -textvariable "combobox" 
    ...
    ttk::combobox "$site_3_0.tCo64" \
        -font "-family {Yu Gothic UI} -size 9" -textvariable "combobox" 
    vTcl:DefineAlias "$site_3_0.tCo64" "TCombobox1" vTcl:WidgetProc "Toplevel1" 1
    ttk::combobox "$site_3_0.tCo65" \
        -font "-family {Yu Gothic UI} -size 9" -textvariable "combobox" 
    vTcl:DefineAlias "$site_3_0.tCo65" "TCombobox2" vTcl:WidgetProc "Toplevel1" 1
    ttk::combobox "$site_3_0.tCo67" \
        -font "-family {Yu Gothic UI} -size 9" -textvariable "combobox" 
    vTcl:DefineAlias "$site_3_0.tCo67" "TCombobox3" vTcl:WidgetProc "Toplevel1" 1
    ttk::combobox "$site_3_0.tCo68" \
        -font "-family {Yu Gothic UI} -size 9" -textvariable "combobox" 
    vTcl:DefineAlias "$site_3_0.tCo68" "TCombobox4" vTcl:WidgetProc "Toplevel1" 1
    ttk::combobox "$site_3_0.tCo69" \
        -font "-family {Yu Gothic UI} -size 9" -textvariable "combobox" 
    vTcl:DefineAlias "$site_3_0.tCo69" "TCombobox5" vTcl:WidgetProc "Toplevel1" 1
    ttk::combobox "$site_3_0.tCo70" \
        -font "-family {Yu Gothic UI} -size 9" -textvariable "combobox" 
    vTcl:DefineAlias "$site_3_0.tCo70" "TCombobox6" vTcl:WidgetProc "Toplevel1" 1
    ttk::combobox "$site_3_0.tCo71" \
        -font "-family {Yu Gothic UI} -size 9" -textvariable "combobox" 
    vTcl:DefineAlias "$site_3_0.tCo71" "TCombobox7" vTcl:WidgetProc "Toplevel1" 1
