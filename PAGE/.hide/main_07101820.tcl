...
#  Jul 10, 2025 06:37:37 PM JST  platform: Windows NT
set vTcl(timestamp) ""
...
proc vTclWindow.top1 {base} {
    ...
    wm geometry $top 1012x542+425+254
    update
    # set in toplevel.wgt.
    global vTcl
    global img_list
    ...
    place $site_3_0.tex60 \
        -in $site_3_0 -x 0 -relx 0.021 -y 0 -rely 0.048 -width 0 \
    ...
    ::vTcl::widgets::ttk::labelframe::createCmd "$top.tLa80" \
        -text "プリセット" -width 490 -height 245 
    vTcl:DefineAlias "$top.tLa80" "TLabelframe1" vTcl:WidgetProc "Toplevel1" 1
    ...
    listbox "$site_3_0.lis81" \
        ...
        -height 210 -highlightcolor SystemWindowText \
    ...
    vTcl:DefineAlias "$site_3_0.lis81" "Listbox1" vTcl:WidgetProc "Toplevel1" 1
    place $site_3_0.lis81 \
        -in $site_3_0 -x 0 -relx 0.02 -y 0 -rely 0.082 -width 0 \
        -relwidth 0.498 -height 0 -relheight 0.857 -anchor nw \
        -bordermode ignore 
    ...
    place $top.tLa56 \
        ...
        -height 0 -relheight 0.795 -anchor nw -bordermode ignore 
    place $top.tSe49 \
